...
**Definition**: Turning product specifications directly into executable AI behaviors and workflows. A prompt engineering approach that transforms PRDs (Product Requirement Documents) into working prototypes through structured AI instructions. Prompt → Spec → Design → Task → Code workflow.
