...
Want to read the rest? The full post is here → [Read on Substack](https://karozieminski.substack.com/p/claude-cowork-anthropic-product-deep-dive)
...
- (Anthropic, shipped, Cowork)
- (Anthropic, built, Cowork in 10 days)
- (Cowork, is_sibling_of, Claude Code)
- (Claude Code, was_used_to_build, Cowork)
- (AI coding agent, built, AI agent feature)
- (Users, used, Claude Code for non-coding work)
- (Users, conducted, vacation research with Claude Code)
- (Users, organized, emails with Claude Code)
- (Users, cancelled, subscriptions with Claude Code)
- (Boris Cherny, documented, user behavior pattern)
- (Boris Cherny, works_at, Anthropic)
- (Boris Cherny, is, engineer)
- (Anthropic, observed, off-label use)
- (Anthropic, removed, terminal interface)
- (Anthropic, simplified, sandbox setup)
- (Anthropic, renamed, product to Cowork)
- (Claude Code, provides, agency and automation)
- (Claude Code, executes, real tasks on computer)
- (Cowork, requires, folder access)
- (Cowork, processes, tasks in parallel)
- (Cowork, executes, file operations)
- (Cowork, creates, files)
- (Cowork, edits, files)
- (Cowork, reads, files)
- (Development timeline, compressed, from months to days)
- (AI-assisted development, is, production-ready)
- (Product teams, should_recognize, user behavior signals)
- (Karo Zieminski, wrote, Product with Attitude article)
- (Karo Zieminski, analyzes, Anthropic product decisions)
- (Product with Attitude, covers, AI product strategy)
...
**Timeframes:**
- 10 days (Cowork development time)
- January 2026
- Week and a half
...
- AI agent building AI agents
- Claude Code vs Cowork
- AI-assisted development timeline
- productizing user behavior
- removing barriers for non-developers
